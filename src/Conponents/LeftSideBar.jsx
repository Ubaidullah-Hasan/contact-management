        ...
        <div className=' bg-gray-800 h-full py-6 px-4 text-white'>
            ...
            <div className='lg:hidden mb-8 text-center'>
                <div className={`${user ? 'avatar online' : 'avatar offline'} relative`}>
                    <MdAddAPhoto onClick={() => setProfileNav(true)} size={25} className={`absolute text-green-500/50 hover:text-green-600 right-9 bottom-2 ${profileImg ? 'hidden' : ''} ${user ? '' : 'hidden'}`} />
